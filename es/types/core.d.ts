export declare type IndexedObject<T = unknown> = Readonly<TypedObject<PropertyKey, T>>;
...
export declare type PartialTypedObject<K extends PropertyKey, V> = {
    readonly [L in K]?: V;
};
...
export declare type TypedObject<K extends PropertyKey, V> = {
    readonly [L in K]: V;
};
