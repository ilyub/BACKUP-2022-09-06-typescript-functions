...
export declare const arrayU: (value: unknown) => types.unknowns | undefined;
export declare const arrays: (value: unknown) => readonly types.unknowns[];
export declare const arraysU: (value: unknown) => readonly types.unknowns[] | undefined;
...
export declare const empty: (value: unknown) => types.empty;
export declare const indexedObject: ((value: unknown) => types.IndexedObject<unknown>) & Readonly<{
    /**
...
export declare const numStr: (value: unknown) => types.NumStr;
export declare const numStrU: (value: unknown) => types.NumStr | undefined;
export declare const numStrs: (value: unknown) => readonly types.NumStr[];
export declare const numStrsU: (value: unknown) => readonly types.NumStr[] | undefined;
...
export declare const stringU: (value: unknown) => types.stringU;
...
export declare const not: {
    readonly array: <V>(value: V) => Exclude<V, types.unknowns>;
    readonly boolean: <V_1>(value: V_1) => Exclude<V_1, boolean>;
    readonly empty: <V_2>(value: V_2) => Exclude<V_2, types.empty>;
    readonly false: <V_3>(value: V_3) => Exclude<V_3, false>;
    readonly indexedObject: <V_4>(value: V_4) => Exclude<V_4, types.IndexedObject<unknown>>;
    readonly map: <V_5>(value: V_5) => Exclude<V_5, ReadonlyMap<unknown, unknown>>;
    readonly null: <V_6>(value: V_6) => Exclude<V_6, null>;
    readonly numStr: <V_7>(value: V_7) => Exclude<V_7, types.NumStr>;
    ...
    readonly stringU: <V_12>(value: V_12) => Exclude<V_12, types.stringU>;
 ...
 * @throws Error otherwise.
 */
export declare function instanceOf<T>(value: unknown, ctor: types.Constructor<T>): T;
/**
 * Asserts that value type is T[].
 *
 * @param value - Value.
 ...
 * @throws Error otherwise.
 */
export declare function instancesOf<T>(value: unknown, ctor: types.Constructor<T>): readonly T[];
